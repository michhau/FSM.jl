...
Base.@kwdef mutable struct EBM{Float64}
    ...
    snow_csnow = zeros(Float64, nrow, ncol, Nsmax)
    snow_E = zeros(Float64, nrow, ncol, Nsmax)
    snow_U = zeros(Float64, nrow, ncol, Nsmax)
    snow_Gs =  zeros(Float64, nrow, ncol, Nsmax)
    snow_dTs = zeros(Float64, nrow, ncol, Nsmax)
    snow_a = zeros(Float64, nrow, ncol, Nsmax)
    snow_b = zeros(Float64, nrow, ncol, Nsmax)
    snow_c = zeros(Float64, nrow, ncol, Nsmax)
    snow_rhs = zeros(Float64, nrow, ncol, Nsmax)
    snow_gamma = zeros(Float64, nrow, ncol, Nsmax)
end
